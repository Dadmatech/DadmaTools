...
from dadmatools.pipeline.utils.sent_utils import get_sent_examples_from_bio_fpath
...
class SentDataset(Dataset):
    def __init__(self, config, bio_fpath, evaluate=False):
        ...
        self.data = get_sent_examples_from_bio_fpath(self.config, bio_fpath, evaluate)
    ...
    def numberize(self):
        ...
        for inst in self.data:
            ...
            entity_label_idxs = self.vocabs[inst['label']]
